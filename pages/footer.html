<footer role='contentinfo'>
	<header>
		<div>
			...
			<div class='faded-text'>By Matvey Kvasov</div>
		</div>
	</header>
	<article class='footer-links'>
		<section class='category-footer-link'>
			<ul class='ul-block-footer'>
				<header>
					<h3>меню</h3>
				</header>
				<li>
					<a href="/index.php" class="footer-link" id='main'>Основная</a>
				</li>
				<li>
					<a href="/pages/about.php" class="footer-link" id='about-us'>О нас</a>
				</li>
				<li>
					<a href="/pages/contacts.php" class="footer-link" id='contacts'>Контакты</a>
				</li>
				<li>
					<a href="/pages/market.php" class="footer-link" id='market'>Продукты</a>
				</li>
				<li>
					<a href="/pages/reviews.php" class="footer-link" id='review'>Отзывы</a>
				</li>
			</ul>
		</section>
		<section class='category-footer-link'>
