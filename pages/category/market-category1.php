...
<head>
	...
	<title>ServiceHub | Категория 1 <?php //TODO: Name of the category ?></title>
...
<body>
	...
	<main>
			<?php 
					...
					showCategories('category1'); // 'category1' - текущая активная категория
			?>
			<article class="cards">
					<?= showCards(4, false); // Показываем меньше карточек для категории ?>
			</article>
	</main>
