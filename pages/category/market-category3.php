...
<head>
	...
	<title>ServiceHub | Категория 3 <?php //TODO: Name of the category ?></title>
...
<body>
	...
	<main>
			<?php 
					...
					showCategories('category3'); // 'category1' - текущая активная категория
			?>
			<article class="cards">
					<?php showCards(12, false); // Показываем меньше карточек для категории ?>
			</article>
	</main>
