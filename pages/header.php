	...
	<nav class="navigator-links">
		<div class="main-links">
			<ul>
				...
				<li>
					<a href="/pages/shopping-cart.php" class='nav-link' id='shopping-cart'>Корзина
						<div class="above-link" id="counts-of-goods"><?php echo isset($_SESSION['goods']) && $_SESSION['isLoggedIn'] ? count($_SESSION['goods']) : ""; ?>
						</div>
					</a>
				</li>
			</ul>
		</div>
		<?php include $_SERVER['DOCUMENT_ROOT'] . "/pages/auth/auth-header.php"; ?>
	</nav>
</header>