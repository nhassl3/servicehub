	...
	<nav class="navigator-links">
		<div class="main-links">
			<ul>
				...
				<li>
					<a href="/pages/shopping-cart.php" class='nav-link' id='shopping-cart'>Корзина<div class="above-link" id="counts-of-goods"><?php echo count($_SESSION['goods']); // TODO: REG COUNT OF GOOD IN CART?></div></a>
				</li>
			</ul>
		</div>
		<div class="auth-links">
			<ul>
				<li>
					<a href="/pages/auth/login.php" class="nav-link" id="login">Login</a>
				</li>
				<li>
					<a href="/pages/auth/register.php" class="nav-link" id="register">Register</a>
				</li>
			</ul>
		</div>
	</nav>
