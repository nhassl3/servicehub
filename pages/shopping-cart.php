	...
	<main>
		<?php
			...
			if ($_SESSION['goods']) {
				?>
				<header>
					<h2 class="h-2">Корзина <div class="above-header" id="counts-of-goods"><?php echo count($_SESSION['goods']) ?></div></h2>
				</header>
				<article class="main">
