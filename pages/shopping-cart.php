...
<head>
	...
	<link rel="stylesheet" href="/assets/css/style-gocheckout-section.css">
...
<body>
	...
	<main>
		<div class="container">
			<?php
			if ($_SESSION['isLoggedIn'] && !empty($_SESSION['goods'])) {
			?>
				<header>
					<h2 class="h-2"><a href="#right-section-buy" class="link cur-d">Корзина</a>
						<div class="above-header" id="counts-of-goods"><?php echo count($_SESSION['goods']) ?></div>
					</h2>
				</header>
				<article class="main">
					<article class="left-zone">
						...
						<article class="goods">
							<section class="left-section-buy">
								...
								<?php
								foreach ($_SESSION['goods'] as $i => $good) {
								?>
									<div class="product-card" id="product-data-<?php echo $i ?>">
										<section class="card">
											<label class="custom-checkbox" for="checkbox-<?php echo $i ?>">
												<input type="checkbox" id="checkbox-<?php echo $i ?>" checkbox-id="checkbox-element">
												<span class="custom-checkbox__checkmark"></span>
												<span class="custom-checkbox__label"></span>
											</label>
										...
										<div class="desc">
											<div class="description-text">
												<div class="short-description" onclick="openModal('description', <?php echo $i ?>);">
											...
											<div class="panel">
												<div class="manage-panel">
													<button class="like <?php echo ($good['like'] ? "clicked" : "") ?> manage-panel-button a32-panel" onclick="toggleLike(this, <?php echo $i ?>);">
													...
													<button class="manage-panel-button a32-panel" onclick="openModal('delete', <?php echo $i ?>);"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
													...
													<button class="manage-panel-button a32-panel pd-wm32" onclick="window.location.href='/pages/gocheckout-fast.php';">
														<div class="fast-buy">
											...
											<div class="change-count">
												...
												<div inputmode="numeric" pattern="[1-9]*" min="1" max="10" class="numeric-input">
													<div class="set-numeric">
														<input inputmode="numeric" pattern="[1-9]*" type="number" class="count-of-good" min="1" max="10" value="1" id="input-numeric-<?php echo $good['id']; ?>">
													</div>
												</div>
				...
				include $_SERVER["DOCUMENT_ROOT"] . "/pages/empty-cart.html";
			}
				?>
		</div>
