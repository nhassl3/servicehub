<article id='right-section-buy' class="right-section-buy">
	...
	<section class="enabled-order-box">
		...
		<section class="info-about-order">
			...
			<div class="order-box">
				<span class="left-section-order-box" id="count-selected-goods">Товары (<?php echo e(0); ?>)</span>
...
</article><?php /**PATH /home/nhassl3/projects/servicehub/resources/views/gocheckout-section.blade.php ENDPATH**/ ?>