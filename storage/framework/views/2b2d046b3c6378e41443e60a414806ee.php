...
?>
	<div class="profile">
		<button class="profile-btn" aria-expanded='false' aria-controls="list">
			Профиль (<?php echo e($user['username']); ?>)
		...
		<ul class="profile-list" id='list' aria-hidden='true'>
			...
			<li class="profile-item">
				<a href="<?php echo e(route("auth.logout")); ?>" class="profile-link" tabindex="-1">Выйти</a>
			</li>
		</ul>
	</div>
<?php
}
?><?php /**PATH /home/nhassl3/projects/servicehub/resources/views/auth/auth-header.blade.php ENDPATH**/ ?>